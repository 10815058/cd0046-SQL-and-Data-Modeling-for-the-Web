...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:Silas123@localhost:5432/todoapp'
...
def show_venue(venue_id):
  ...
  for show in venue.shows:
    show_info = {
      ...
      'artitst_image_link':show.artist.image_link,
